<docs>
          ...
          <template v-else>
            <TimerStop
              ...
              @update:time="
                ...
                wordCount>sentences[j].length?sentenceCountIter():null
              "
            />
            ...
            >
              <template v-for="(sentence,sentenceIndex) in sentences">
                <span
                v-for="(word, wordIndex) in sentences"
                :key="wordIndex"
  ...
  export default {
    ...
    computed:{
      chunks() {
        return [...context,...triggersentence,...continuation];
      },
      sentences(){
        return [context,triggersentence,continuation]
      }
